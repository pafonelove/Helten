...
namespace GameSpace
{
    ...
    public class Game
    {
        ...
        static int[] traderFoodItemsCount = { 5, 3, 6 };
        ...
        static int[] traderWeaponsItemsCount = { 2, 3, 1 };
        ...
        static int[] traderArmorItemsCount = { 3, 4, 2 };
        ...
        static int[] traderPotionsItemsCount = { 10, 5, 3 };
