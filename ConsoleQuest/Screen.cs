...
namespace GameScreen
{
    ...
    public class Screen
    {
        ...
        {
            if (Game.languageFlag)
                Console.Write($"    You picked up {weaponName}. Damage - {damage}.");
            else
                Console.Write($"    Вы взяли в руки {weaponName}. Урон - {damage}."); 
        }
        ...
        {
            if (Game.languageFlag)
                Console.Write($"    You have equipped {armorName}. Health increased by {armor} points.");
            else
                Console.Write($"    Вы надели {armorName}. Здоровье увеличено на {armor} единиц.");
        }
        ...
        {
            Console.WriteLine("\n    Contol is carried out by entering a specific number and pressing the Enter key.\n" +
